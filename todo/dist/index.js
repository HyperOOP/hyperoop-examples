(function () {
  ...
  ***************************************************************************** */
  ...
  const TodoItem = ({ item }) => (h$1("li", { class: item.State.done && "done", onclick: () => item.State.done = !item.State.done }, item.State.value));
  ...
  const view$1 = view(todo, () => (h$1("div", null,
      h$1("h1", null, "Todo"),
      h$1("p", null, todo.UnusedFilters.map((key) => h$1(FilterButton, { filter: key }))),
      h$1("div", { class: "flex" },
      ...
      h$1("p", null,
          h$1("ul", null,
              " ",
              todo.Filtered.map((t) => h$1(TodoItem, { item: t })),
              " ")))));
